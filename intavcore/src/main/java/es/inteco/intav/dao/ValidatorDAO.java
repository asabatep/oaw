...
public class ValidatorDAO {
	...
	public static ValidatorForm getValidator(Connection c) throws Exception{
		...
		String query = "SELECT p.status, p.url, p.pdf_percentage FROM observatorio_validator p WHERE 1=1";
	...
	public static void update(Connection c, ValidatorForm validator) throws SQLException {
		final String query = "UPDATE observatorio_validator SET status = ?, url = ?, pdf_percentage = ? WHERE 1=1";
